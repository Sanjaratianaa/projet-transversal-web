...
import DepenseStats from "./depense-stats"
import RevenueTable from "./depense-table"
import RevenueFormDialog from "./depense-form-dialog"
import GlobalCeilingCard from "./global-ceiling-card"
import RevenueFilters from "./depense-filters"
import { useRevenues } from "@/hooks/use-revenues"
import type { DepenseFormData } from "@/types/depense"

export default function DepenseDashboard() {
  const {
    revenues,
    allRevenues,
    filters,
  ...
  const handleAddRevenue = (data: DepenseFormData) => {
    addRevenue(data)
  }

  const handleUpdateRevenue = (id: string, data: DepenseFormData) => {
