...
@Component({
  selector: 'app-add-specialite-modal',
  standalone: true,
  templateUrl: './specialite-modal.component.html',
  imports: [
    NgIf, NgFor,
    ReactiveFormsModule,
    MatDialogModule,
...
export class SpecialiteModalComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.mecaniciensOptions = this.data.fields.find((f: Field) => f.name === 'id_mecanicien')?.options || [];
